...
def analyze(test_image_dir='CUB_200_2011/test_cropped/023.Brandt_Cormorant', test_image_name ='Brandt_Cormorant_0092_23061.jpg' ):
    ...
    #test_image_dir = 'CUB_200_2011/test_cropped/001.Black_footed_Albatross' #'./local_analysis/Painted_Bunting_Class15_0081/'

  #test_image_dir = 'CUB_200_2011/test_cropped/023.Brandt_Cormorant' #'./local_analysis/Painted_Bunting_Class15_0081/'

    #test_image_name = args.img[0] #'Painted_Bunting_0081_15230.jpg'
    #test_image_name = 'Black_Footed_Albatross_0001_796111.jpg' #'Painted_Bunting_0081_15230.jpg'
  #test_image_name = 'Brandt_Cormorant_0092_23061.jpg' #'Painted_Bunting_0081_15230.jpg'
    #test_image_label = args.imgclass[0] #15
    test_image_label = 23 #15
    ...
    load_model_dir = './saved_models/vgg19/001/'
    #load_model_name = args.model[0] #'10_18push0.7822.pth'
    load_model_name = '100_1push0.7413.pth' #'10_18push0.7822.pth'
    ...
    for i,c in enumerate(topk_classes.detach().cpu().numpy()):
        ...
        for j in reversed(sorted_indices_cls_act.detach().cpu().numpy()):
            ...
            print('last layer connection: {0}'.format(ppnet.last_layer.weight[c][prototype_index]))
